...
const Education = () => {
  return (
    <section className="scroll-mt-24 my-20" id='education'>
       <div className="max-w-5xl mx-auto px-1" data-aos="fade-right">
        <h2 className="text-3xl font-bold text-center mb-12 text-base-content">
          Education
        </h2>

        <div className="flex flex-col md:flex-row justify-between items-start gap-1 md:gap-0 bg-base-100 shadow-md border border-base-300 p-8 md:p-10 rounded-lg">
